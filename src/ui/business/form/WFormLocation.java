...
public class WFormLocation extends WAbstractFormPanel<Location> {
    ...
    public WFormLocation() {
        ...
        this.comboBoxReservation = new WFormComboBox<Reservation>("R√©servation", (ArrayList<Reservation>) ReservationDao.retrieveAll(true));
        ...
        this.textFieldDepartKm = new WFormTextField("Kilom√©trage avant le d√©part");
        ...
        this.comboBoxVehicule = new WFormComboBox<Vehicule>("V√©hicule", (ArrayList<Vehicule>) VehiculeDao.retrieveAll());
        ...
        this.buttonPay.events().addListener(new EventListener() {
            ...
            public void handleEvent(Event evt) {
              ...
              case BUTTON_CLICKED:
            	  ...
            	  list.add(new TypePaiement(type.D…BIT));
            	  list.add(new TypePaiement(type.CR…DIT));
            	  WFormComboBox<TypePaiement> comboPaiement = new WFormComboBox<>("MÈthode de paiement", list);
