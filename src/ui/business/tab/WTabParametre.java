      ...
      public void handleEvent(Event evt) {
        switch ((WForm.Events) evt.getEventName()) {
          case BUTTON_SAVE_CLICK:
            ...
            listParametre.setModel(ArrayListHelper.toDefaultListModel(parametres)); //Pourquoi est-ce que �a refresh avec NULL comme valeur dans la liste? Parce que le form ne contient pas de type?
            break;
